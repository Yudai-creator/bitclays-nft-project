const AppFeatured = () => {
    return ( 
        <section className="featured relative p-8 mt-40">
          ...
          An NFT collection that holds history.
          </h2>
          <div className="featured__artwork flex justify-center">
            <img className="artwork_img max-w-md" src="https://ik.imagekit.io/u33i3sss0/bitclays_nft/clay_table_6rzEjkQE3.png?ik-sdk-version=javascript-1.4.3&updatedAt=1664560844431" alt="clay table"></img>
